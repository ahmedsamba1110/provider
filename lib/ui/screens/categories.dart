import 'package:edemand_partner/cubits/manageCategoryPreferenceCubit.dart';
    ...
    return PopScope(
      ...
      child: InterstitialAdWidget(
        child: Scaffold(
          ...
          body: mainWidget(),
          // floatingActionButton: manageCategotyButton(),
        ),
      ),
    );
  }
    ...
    return BlocConsumer<ManageCategoryPreferenceCubit,
      ...
      listener: (context, state) {
        if (state is ManageCategoryPreferenceFailure) {
          UiUtils.showMessage(
            context,
           message:  'selectCategory'.translate(context: context),
          ...
          UiUtils.showMessage(
            context,
          message:   'categoryUpdated'.translate(context: context),
