import 'package:edemand_partner/cubits/bookingPaymentManagementCubit.dart';
import 'package:edemand_partner/data/model/bookingPaymentDataModel.dart';
...
class BookingPaymentDataScreen extends StatefulWidget {
  ...
  @override
  BookingPaymentDataScreenState createState() => BookingPaymentDataScreenState();

  static Route<BookingPaymentDataScreen> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => BlocProvider(
        create: (BuildContext context) => FetchBookingPaymentManagementDataCubit(),
...
class BookingPaymentDataScreenState extends State<BookingPaymentDataScreen> {
  ...
  @override
  void initState() {
    context.read<FetchBookingPaymentManagementDataCubit>().fetchBookingPaymentManagementData();
    super.initState();
  }
  ...
  void _pageScrollListen() {
    if (_pageScrollController.isEndReached()) {
      if (context.read<FetchBookingPaymentManagementDataCubit>().hasMoreData()) {
        context
    ...
    return InterstitialAdWidget(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: CustomText(
            'bookingPaymentManagement'.translate(context: context),
                    ...
                    builder: (BuildContext context) => Positioned.directional(
                      ...
                      child: CustomContainer(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            'bookingPaymentManagementDescription'.translate(context: context),
                            style: TextStyle(
                              color: Theme.of(context).colorScheme.blackColor,
                              fontSize: 12,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: CustomText(
                            bookingPaymentData[index].type.translate(context: context),
                            fontSize: 14,
                            color: Theme.of(context).colorScheme.blackColor,
                          ),
                        ),
  ...
  Widget mainWidget() {
    return CustomRefreshIndicator(
      ...
      child: BlocBuilder<FetchBookingPaymentManagementDataCubit,
        ...
        builder: (BuildContext context, FetchBookingPaymentManagementDataState state) {
