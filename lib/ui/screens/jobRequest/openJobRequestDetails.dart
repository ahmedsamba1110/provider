...
import 'package:edemand_partner/cubits/applyForCustomJobCubit.dart';
  ...
  Widget bottomNavigation() {
    return BlocConsumer<ApplyForCustomJobCubit, ApplyForCustomJobCubitState>(
      ...
      if (state is ApplyForCustomJobSuccess) {
        ...
        UiUtils.showMessage(
          context,
          message: 'detailsUpdatedSuccessfully'.translate(context: context),
          ...
          onTap: () {
            ...
            if (selectedTax == '') {
              UiUtils.showMessage(context,
                  message: 'pleaseSelectTax'.translate(context: context),
          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextFormField(
                ...
                currNode: coverNoteFocus,
                nextFocus: minuteNoteFocus,
                validator: (String? value) {
                    ...
                    children: [
                      Flexible(
                        child: CustomTextFormField(
                          bottomPadding: 10,
                          isDense: false,
                          labelText: 'enterMinutes'.translate(context: context),
                          hintText: 'enterMinutes'.translate(context: context),
                          allowOnlySingleDecimalPoint: true,
                          controller: minuteController,
                          currNode: minuteNoteFocus,
                          validator: (String? value) {
                            return Validator.nullCheck(context, value);
                          },
                          textInputType: TextInputType.number,
