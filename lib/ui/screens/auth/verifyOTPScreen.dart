      ...
      child: Builder(
        builder: (BuildContext context) {
          ...
          if (resendOtpState is ResendOtpFail) {
            UiUtils.showMessage(
                context,
               message:  resendOtpState.error.toString().translate(context: context),
    ...
    return BlocConsumer<VerifyOtpCubit, VerifyOtpState>(
      listener: (BuildContext context, VerifyOtpState verifyOtpState) {
        if (verifyOtpState is VerifyOtpSuccess) {
          ...
          //
          UiUtils.showMessage(context,message:  'verified'.translate(context: context),
          ...
          //
          UiUtils.showMessage(context,message:  errorMessage,type:  ToastificationType.error);
        }
      },
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    const CustomSvgPicture('loginlogo',
