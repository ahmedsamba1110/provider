...
import 'package:edemand_partner/cubits/sendQueryToAdminCubit.dart';
                  ...
                  _buildContactInfoWidget(
                    ...
                    onTap: () async {
                      try {
                        ...
                        UiUtils.showMessage(
                            context,
                           message:  "unableToOpen".translate(context: context),
    ...
    return BlocConsumer<SendQueryToAdminCubit, SendQueryToAdminState>(
      listener: (context, state) {
        ...
        if (state is SendQueryToAdminFailureState) {
          UiUtils.showMessage(
              context,
             message:  "weCouldntSendYourRequestPleaseTryAgainLater"
                  .translate(context: context),
             type:  ToastificationType.error);
          ...
          UiUtils.showMessage(
              context,
             message:  "yourRequestHasBeenSuccessfullySent".translate(context: context),
