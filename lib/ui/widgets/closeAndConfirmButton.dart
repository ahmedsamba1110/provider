            ...
            child: CustomInkWellContainer(
              ...
              child: CustomContainer(
                ...
                decoration: BoxDecoration(
                  borderRadius:
                      const BorderRadiusDirectional.only(bottomStart: Radius.circular(UiUtils.borderRadiusOf10)),
                  boxShadow: const [
                    BoxShadow(
          ...
          Expanded(
            child: CustomInkWellContainer(
              ...
              child: CustomContainer(
                height: 44,
                decoration: BoxDecoration(
                  borderRadius: const BorderRadiusDirectional.only(bottomEnd: Radius.circular(UiUtils.borderRadiusOf10)),
                  boxShadow: const [
                    BoxShadow(
                      color: Color(0x1c343f53),
                      offset: Offset(0, -3),
