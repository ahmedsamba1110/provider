  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: StatefulBuilder(
        builder: (final BuildContext context, final setStater) => CustomSizedBox(
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: List.generate(int.parse(widget.advanceBookingDays), (index) {
                        ...
                        final String day = listOfDay[date.weekday - 1].translate(context: context);
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                CustomText(day.length > 3 ? day.substring(0, 3) : day,
                    ...
                    child: BlocConsumer<TimeSlotCubit, TimeSlotState>(
                      ...
                      builder: (final context, final state) {
                        ...
                        final Color disabledTimeSlotColor =
                            Theme.of(context).colorScheme.lightGreyColor.withValues(alpha: 0.35);
