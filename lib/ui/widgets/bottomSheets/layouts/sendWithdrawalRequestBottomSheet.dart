...
class SendWithdrawalRequestScreenState extends State<SendWithdrawalRequestBottomsheet> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      canPop: true,
      child: BottomSheetLayout(title: "sendWithdrawalRequest", child: withdrawAmountForm()),
    );
  }
    ...
    return BlocConsumer<SendWithdrawalRequestCubit, SendWithdrawalRequestState>(
      listener: (BuildContext context, SendWithdrawalRequestState state) {
        if (state is SendWithdrawalRequestSuccess) {
          ...
          UiUtils.showMessage(
            context,
           message:  'success'.translate(context: context),
        ...
        if (state is SendWithdrawalRequestFailure) {
          UiUtils.showMessage(context,message:  'failed'.translate(context: context),type:  ToastificationType.error);
        }
      },
